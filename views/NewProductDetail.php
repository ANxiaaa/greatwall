...
<body>
  ...
  <script>
    ...
    $(function () {
      ...
      // ---
      const columns = [
        { key: 'aaa', label: '货号', width: '20%' },
        { key: 'bbb', label: '型号', width: '20%' },
        { key: 'zzz', label: '规格', width: '20%' },
        { key: 'xxx', label: '盒装', width: '20%' },
        { key: 'sss', label: '箱装', width: '20%' },
      ];

      const data = [
        { aaa: '123123', bbb: '1231444', zzz: 'fasfax', xxx: 'ddd', sss: 'dasd' },
        { aaa: '333', bbb: '444', zzz: '555', xxx: 'asa', sss: 'xxx' },
      ];
      $(".myTable").useTable({
        columns,
        data,
